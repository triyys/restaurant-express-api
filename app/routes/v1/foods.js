...
const { validateRequestBody, validateQuery, verifyAccessToken, validateObjectId } = require('@/middlewares');
...
router.post('/', verifyAccessToken, validateRequestBody(['name', 'price', 'type']), createFood);
